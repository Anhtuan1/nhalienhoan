...
class ProductsController extends AppController {
	...
	function listproduct($id=null) {
		...
		mysql_query("SET names utf8");       
      	$this->set('newsproducts', $this->Product->find('all',array('conditions'=>array('Product.status'=>1,'Product.catproduct_id'=>$id,'Product.sptieubieu'=>'1'),'limit'=>21,'order' => 'Product.id DESC')));
...
//	$this->paginate = array('conditions'=>array('Product.status'=>1,'Product.title like'=>'%'.$name_search.'%'),'limit'=>16);		
	...
	$chuoi = str_replace(array('BA'),'',$s); 
	$hang= isset($_POST['hang'])?$_POST['hang']:'';
	$system= isset($_POST['system'])?$_POST['system']:'';
	$this->paginate = array('conditions'=>array('Product.status'=>1,'Product.id LIKE'=> "%$chuoi%",'Product.manufacturer LIKE'=> "%$hang%",'Product.catproduct_id LIKE'=> "%$system%"),'limit' => '21','order' => 'Product.id DESC');
