        ...
        <div class="tab-content default-tab" id="tab2">   
            <table class="input">
				...
				<tr>
                    ...
                    <td>
                    <input type="radio" value="0" id="categorytatus0" name="data[Category][menu]"> Không 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="categorytatus1" name="data[Category][menu]"> Có
                    </td>
                </tr>
				<tr>
                  	<td class="label">Xuất hiện trang chủ:</td>
                    <td>
                    <input type="radio" value="0" id="categorytatus0" name="data[Category][home]"> Không 
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="categorytatus1" name="data[Category][home]"> Có
                    </td>
                </tr>
                <!--<tr>
