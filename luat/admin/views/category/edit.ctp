        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
               ...
               <tr>
				...
				<tr>
                  	<td class="label">Xuất hiện menu:</td>
                    <td><input type="radio" value="0" id="categorytatus0" name="data[Category][menu]" <?php if($this->data['Category']['menu'] == 0 ) echo "checked"; ?>> Không
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="categorytatus1" name="data[Category][menu]" <?php if($this->data['Category']['menu'] == 1 ) echo "checked"; ?>> Có
                    </td>
                </tr>
				
				<tr>
                  	<td class="label">Xuất hiện trang chủ:</td>
                    <td><input type="radio" value="0" id="categorytatus0" name="data[Category][home]" <?php if($this->data['Category']['home'] == 0 ) echo "checked"; ?>> Không
                    	&nbsp;&nbsp;&nbsp;<input type="radio" checked="checked" value="1" id="categorytatus1" name="data[Category][home]" <?php if($this->data['Category']['home'] == 1 ) echo "checked"; ?>> Có
                    </td>
                </tr>
                <!--<tr>
