        ...
        <div class="tab-content default-tab" id="tab1">
        	<table class="input">
                ...
                <tr>
				  ...
				  <tr>
                  	<td class="label">Kinh doanh 1:</td>
                    <td>
                    <?php echo $form->input('Setting.kinhdoanh1',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </td>
                </tr>
				  <tr>
                  	<td class="label">Kinh doanh 2:</td>
                    <td>
                    <?php echo $form->input('Setting.kinhdoanh2',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </td>
                </tr>
				  <tr>
                  	<td class="label">Kỹ thuật:</td>
                    <td>
                    <?php echo $form->input('Setting.kithuat',array( 'label' => '','class'=>'text-input medium-input datepicker'));?>
                    </td>
                </tr>
                <tr>
